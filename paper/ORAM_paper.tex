...
\begin{figure}[h!]
  ...
  \caption{[b]Graph 1:[/b] Evaluation of runtime of program based on blocks already in tree}
...
\begin{figure}[h!]
  ...
  \caption{[b]Graph 2:[/b] Evaluation of overflow of tree when adding blocks without removal}
